...
Added socket support by pawel lokoz.com
*/
...
if(file_exists('/home/'.get_current_user().'/tmp/memcache.sock'))
{

if ( ! defined( 'WP_CACHE_KEY_SALT' ) ) {
	define( 'WP_CACHE_KEY_SALT', md5($_SERVER['SERVER_NAME']) );
}
...
class WP_Object_Cache {
	...
	function __construct() {
		...
		$path_memcached = 'unix:///home/'.get_current_user().'/tmp/memcache.sock';
		...
		if ( isset( $memcached_servers ) ) {
			...
			//$buckets = array($path_memcached.":0");
		}
